        ...
        <Row className="align-items-center footer-content">
          <Col size={12} sm={6} className="footer-left">
            <div className="footer-brand">
              <h3 className="footer-name">Mazid Khan</h3>
              <p className="footer-title">Full Stack / MERN Stack Developer</p>
          ...
          <Col size={12} sm={6} className="footer-right text-center text-sm-end">
            <div className="social-icons-footer">
              ...
              <a 
                href="mailto:mazidkhanss12@gmail.com"
            ...
            <div className="footer-copyright">
              <p>
                Made with <FaHeart className="heart-icon" /> by Mazid Khan
              </p>
